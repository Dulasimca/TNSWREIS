...
@Component({
  selector: 'app-hostelwisedata-report',
  templateUrl: './hostelwisedata-report.component.html',
  styleUrls: ['./hostelwisedata-report.component.css']
})
export class HostelwisedataReportComponent implements OnInit {
  hostel: any;
  district: any;
  taluk: any;
  HostelId: number
  ...
  constructor(private http: HttpClient, private restApiService: RestAPIService,
    ...
    ngOnInit(): void {
      this.hostelCols = this.tableConstants.onlineapplicationstatusCols;
      this.Slno = 0;
