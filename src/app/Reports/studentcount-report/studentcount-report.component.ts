...
@Component({
  selector: 'app-studentcount-report',
  templateUrl: './studentcount-report.component.html',
  styleUrls: ['./studentcount-report.component.css']
})
export class StudentcountReportComponent implements OnInit {
  hostel: any;
  district: any;
  taluk: any;
  HostelId: number
  ...
  ngOnInit(): void {
    this.studentcountCols = this.tableConstants.studentCountReportCols
    this.Slno = 0;
