...
@Component({
  selector: 'app-devicemapping-report',
  templateUrl: './devicemapping-report.component.html',
  styleUrls: ['./devicemapping-report.component.css']
})
export class DevicemappingReportComponent implements OnInit {
  hostel: any;
  district: any;
  taluk: any;
  HostelId: number
  ...
  ngOnInit(): void {
    this.hostelCols = this.tableConstants.DeviceMappingReportCols
    this.Slno = 0;
