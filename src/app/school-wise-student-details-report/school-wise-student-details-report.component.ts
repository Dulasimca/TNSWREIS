...
@Component({
  selector: 'app-school-wise-student-details-report',
  templateUrl: './school-wise-student-details-report.component.html',
  styleUrls: ['./school-wise-student-details-report.component.css']
})
export class SchoolWiseStudentDetailsReportComponent implements OnInit {
  hostel: any;
  district: any;
  taluk: any;
  HostelId: number
  ...
  constructor(private http: HttpClient, private restApiService: RestAPIService,
    ...
    ngOnInit(): void {
      this.hostelCols = this.tableConstants.schoolwisestudentdetailsCols;
      this.Slno = 0;
